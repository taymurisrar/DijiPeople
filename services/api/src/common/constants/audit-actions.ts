...
export const AUDIT_ACTIONS = {
  ...
  /*
   * Customization package ALM — TASK-0033. Values of environment variables are
   * never written to the audit trail, only the key that changed.
   */
  PACKAGE_RELEASED: 'PACKAGE_RELEASED',
  PACKAGE_EXPORTED: 'PACKAGE_EXPORTED',
  PACKAGE_DEPENDENCIES_UPDATED: 'PACKAGE_DEPENDENCIES_UPDATED',
  PACKAGE_IMPORT_ANALYZED: 'PACKAGE_IMPORT_ANALYZED',
  ...
  PACKAGE_DETACHED: 'PACKAGE_DETACHED',
  PACKAGE_PUBLISHER_CREATED: 'PACKAGE_PUBLISHER_CREATED',
  PACKAGE_ENVIRONMENT_VARIABLE_CREATED: 'PACKAGE_ENVIRONMENT_VARIABLE_CREATED',
  PACKAGE_ENVIRONMENT_VALUE_SET: 'PACKAGE_ENVIRONMENT_VALUE_SET',
  ...
  // BUG-2007 - real delete for projects and customers.
...
export const AUDIT_ENTITY_TYPES = {
  ...
  CUSTOMIZATION_PACKAGE: 'CustomizationPackage',
  CUSTOMIZATION_PACKAGE_OPERATION: 'CustomizationPackageOperation',
  CUSTOMIZATION_PUBLISHER: 'CustomizationPublisher',
  CUSTOMIZATION_ENVIRONMENT_VARIABLE: 'CustomizationEnvironmentVariable',
} as const;
