...
export const LEAD_STATUS_OPTIONS = [
  ...
  {
    value: LeadStatus.AGREEMENT,
    label: 'Agreement',
    description:
      'Contracting identity and commercial terms are confirmed and the customer agreement is in progress.',
    tone: 'info',
    sortOrder: 35,
    isActive: true,
    isSystem: true,
    ...
    criteria: [
      ...
      recommendedField('lead.taxId', 'Tax or VAT number', 'taxId', 45),
      requiredField(
        'lead.authorizedSignerName',
        'Authorized signatory',
        'authorizedSignerName',
        50,
      ),
      requiredField(
        'lead.authorizedSignerTitle',
        'Signatory job title',
        'authorizedSignerTitle',
        60,
      ),
      requiredField(
        'lead.authorizedSignerEmail',
        'Signatory email',
        'authorizedSignerEmail',
        70,
      ),
      requiredField('lead.agreedPlanId', 'Selected plan', 'agreedPlanId', 80),
      requiredField('lead.agreedSeats', 'Agreed seats', 'agreedSeats', 90),
      requiredField('lead.agreedPrice', 'Agreed price', 'agreedPrice', 100),
      requiredField('lead.billingCycle', 'Billing cycle', 'billingCycle', 110),
      requiredField(
        'lead.subscriptionTerm',
        'Subscription term',
        'subscriptionTerm',
        120,
      ),
      requiredField('lead.paymentTerms', 'Payment terms', 'paymentTerms', 130),
      requiredField(
        'lead.proposedEffectiveDate',
  ...
  },
  {
    ...
    criteria: [
      ...
      systemCheck(
        'lead.governingAgreementExecuted',
        'Customer agreement fully executed',
        65,
        'The DijiPeople SaaS Subscription & Services Agreement must be fully executed before conversion.',
      ),
      manualConfirmation(
