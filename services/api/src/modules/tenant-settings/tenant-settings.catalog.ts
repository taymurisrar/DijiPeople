...
export const DEFAULT_TENANT_SETTINGS: TenantSettingDefaults = {
  ...
  employees: {
    ...
    requirePrimaryWorkLocation: false,
    ...
    preventDuplicateNationalId: false,
