...
const OPERATORS_BY_TYPE: Record<string, ReportFilterOperator[]> = {
  ...
  percent: ['eq', 'ne', 'gt', 'gte', 'lt', 'lte', 'between', 'isnull', 'isnotnull'],
  money: ['eq', 'ne', 'gt', 'gte', 'lt', 'lte', 'between', 'isnull', 'isnotnull'],
  duration_minutes: ['eq', 'ne', 'gt', 'gte', 'lt', 'lte', 'between', 'isnull', 'isnotnull'],
