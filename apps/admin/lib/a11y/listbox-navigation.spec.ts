...
/*
 * Mirrors apps/web/lib/a11y/listbox-navigation.spec.ts — see that file's
 * sibling module for why this is duplicated rather than imported across apps.
 */
...
describe("activeDescendantId", () => {
  ...
  it("is undefined rather than a dangling reference", () => {
    // aria-activedescendant pointing at no element is itself a violation
    // (BUG-3377's exact defect: attributes written, targets never rendered).
