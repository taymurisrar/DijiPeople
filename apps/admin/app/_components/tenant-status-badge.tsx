...
const statusStyles: Record<string, string> = {
  ...
  PROVISIONING_FAILED: "border-rose-200 bg-rose-50 text-rose-700",
  DECOMMISSIONING: "border-amber-200 bg-amber-50 text-amber-700",
  DECOMMISSIONED: "border-slate-300 bg-slate-200 text-slate-700",
