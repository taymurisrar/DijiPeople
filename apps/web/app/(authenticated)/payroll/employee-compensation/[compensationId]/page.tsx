...
export default async function EmployeeCompensationRecordPage({
  params,
  searchParams,
}: Props) {
  ...
  return (
    <PayrollLayoutShell
      title={stringValue(displayRecord.employeeName) || "Employee Compensation"}
      description="View the employee compensation record."
    >
