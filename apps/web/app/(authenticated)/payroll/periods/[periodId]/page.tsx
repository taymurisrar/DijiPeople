...
export default async function PayrollPeriodRecordPage({
  params,
  searchParams,
}: Props) {
  ...
  return (
    <PayrollLayoutShell
      title={typeof record.name === "string" ? record.name : "Payroll Period"}
      description="View payroll period dates, cutoff, payment schedule, and status."
    >
