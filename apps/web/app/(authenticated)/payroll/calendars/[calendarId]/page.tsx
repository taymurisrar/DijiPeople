...
export default async function PayrollCalendarRecordPage({
  params,
  searchParams,
}: Props) {
  ...
  return (
    <PayrollLayoutShell
      title={typeof record.name === "string" ? record.name : "Payroll Calendar"}
      description="View the payroll calendar definition and related defaults."
    >
