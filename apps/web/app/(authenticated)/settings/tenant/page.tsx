...
function buildOrganizationSections(): SettingsSectionConfig[] {
  return [
    {
      ...
      fields: [
        {
          ...
          description: "Workspace name stored on the tenant record.",
          type: "text",
        },
        {
          category: "organization",
        ...
        },
        {
          ...
          description:
            "Registered legal name used for official and financial references.",
          type: "text",
        },
        {
          category: "branding",
          ...
          label: "Short name",
          description:
            "Compact name used in tight UI spaces such as headers and cards.",
          type: "text",
        },
        {
          category: "organization",
        ...
        },
        {
          ...
          description:
            "Official website URL shown in branded and support experiences.",
          type: "url",
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "HR email",
          description:
            "Primary HR contact used in onboarding and employee support flows.",
          type: "email",
        },
        {
          category: "branding",
          ...
          label: "Support email",
          description:
            "Support contact for platform or service-related communication.",
          type: "email",
        },
        {
          category: "organization",
      ...
      fields: [
        {
          ...
          description:
            "Used for attendance, scheduling, reminders, and timestamp rendering.",
          type: "lookup",
          lookupKey: "timezones",
        ...
        },
        {
          ...
          description:
            "Primary currency used in payroll, budgets, and financial displays.",
          type: "lookup",
        ...
        },
        {
          ...
          label: "Locale",
          description:
            "Regional formatting preference used across the workspace.",
          type: "select",
          options: [
        ...
        },
        {
          ...
          label: "Date format",
          description:
            "Default date format shown across forms, tables, and exports.",
          type: "select",
          options: [
        ...
        },
        {
          ...
          description:
            "Used in calendars, timesheets, attendance summaries, and planning views.",
          type: "select",
          options: [
...
export default async function TenantSettingsPage() {
  ...
  return (
    <SettingsShell
      ...
      title="Company Profile"
    >
      <TenantSlugForm canEdit={canEditTenantSlug} initialSlug={tenantSlug} />
