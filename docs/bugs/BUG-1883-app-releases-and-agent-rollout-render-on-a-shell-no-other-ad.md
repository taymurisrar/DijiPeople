...
## QA Retest
Retested 2026-08-29 by the regression-guard sweep: `apps/admin/lib/desktop-agent-settings.spec.ts` ran and passed, as part of `npm --workspace admin run test` (379 passing).
...
- `apps/admin/lib/desktop-agent-settings.spec.ts`
