...
Unit: `platform-runtime.validate-contract.spec.ts`, 4 cases, mutation-tested —
restoring the original behaviour fails 2 of 4. Full API suite green: 1800 tests,
226 suites. Scenario [[QA-PLATFORM-023]] covers the browser half, which the unit
test cannot reach.
