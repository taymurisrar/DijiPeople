...
scenario S1) on a throwaway database: no error modal appeared. On production
after release PR #80 (merge commit e253306a, deployed 2026-09-13):
Customization pages loaded with no dialog. CI runs 34732185363, 34732682935
and 34732697734 passed on f865ac5e (the merged tree). Scenario
QA-SETTINGS-025:
