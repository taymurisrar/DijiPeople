...
A spec asserting that a sign-in through the web route handler produces matching
attribution on the audit row and the session row. Registered as a regression
entry once written.
