...
## QA Retest
Retested 2026-08-29 by the regression-guard sweep: `e2e/tests/landing-checkout-provisioning.spec.ts` ran and passed, as part of the CI **Browser e2e** job on `9e55663`.
...
- the CI **Browser e2e** job on `9e55663`
