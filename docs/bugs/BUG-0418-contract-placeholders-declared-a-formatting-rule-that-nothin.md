...
summary: REG-185 names `services/api/src/modules/contracts/placeholder-formatting.spec.ts`, and that is what was executed.
...
- Regression — REG-185 (see the regression register)
