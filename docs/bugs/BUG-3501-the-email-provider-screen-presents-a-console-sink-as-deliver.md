...
scenario S17) on a throwaway database. On production after release PR #80
(merge commit e253306a, deployed 2026-09-13): the providers page states "Email
is delivered by the DijiPeople platform relay", with the Console provider
shown "Not used". A real email through the relay was not sent by hand as part
of this retest; the first one is the tenant's 09:00 UTC scheduled report. CI
runs 34732185363, 34732682935 and 34732697734 passed on f865ac5e (the merged
tree). Scenarios QA-SETTINGS-030 (API, resolution, seed) and
