...
Decided in [[ADR-0011]] and implemented in
...
- 2026-09-12 — fixed in SESSION-0103. Decision recorded as [[ADR-0011]];
  implementation in `EXECPLAN-0042`; regression register entry REG-460.
