...
## QA Retest
Retested 2026-08-29 by the regression-guard sweep: `services/api/src/modules/super-admin/plan-lifecycle.spec.ts` ran and passed, as part of `npm --workspace api run test` (2016 passing).
...
- `services/api/src/modules/super-admin/plan-lifecycle.spec.ts`
