...
- Regression register entry: REG-418. Reusable QA scenario: QA-UI-001 (manual —
...
- 2026-09-12 — fixed in SESSION-0103, branch `agent/r-s6-lookups`. REG-418 and
...
- Regression — REG-418 (see the regression register)
