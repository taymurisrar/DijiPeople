...
## QA Retest
Retested 2026-08-29 by the regression-guard sweep: `apps/web/app/components/ui/login-field-accessibility.spec.ts` ran and passed, as part of `npm --workspace web run test` (888 passing).
...
- `apps/web/app/components/ui/login-field-accessibility.spec.ts`
