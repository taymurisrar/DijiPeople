...
scenario S1) on a throwaway database, and on production after release PR #80
(merge commit e253306a, deployed 2026-09-13): with the owner's temporary System
Customizer role removed, `/settings/customization/modules` still loads and
lists the QA Asset module, with no denial or server error. CI runs 34732185363,
