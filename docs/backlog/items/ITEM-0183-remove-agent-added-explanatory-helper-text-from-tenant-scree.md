...
**PARTIAL.** The login page's "Remember me" hint was confirmed removed in the
local browser QA run
(`docs/qa/runs/2026-09-13-task-0031-demo-walkthrough-2-local-browser-qa-e253306.md`).
The other eleven occurrences listed in Evidence were not individually
re-checked in a browser during this retest; their removal rests on the code
changes recorded in Resolution and on the mutation-tested regression specs. CI
