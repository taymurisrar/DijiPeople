...
scenarios S12 and S13) on a throwaway database: the Work Sites related-records
tab renders, and a direct `PATCH` attempting to change `locationId` returns
400. Not separately re-exercised on production. CI runs 34732185363,
34732682935 and 34732697734 passed on f865ac5e (the merged tree).
