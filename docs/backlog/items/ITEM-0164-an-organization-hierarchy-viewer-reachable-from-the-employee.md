...
- 2026-09-13 — first browser check on production (`df0f84f1`) found the dialog's
  layout and interaction defects; filed as [[BUG-3499]]. Owner decided the
  viewer stays a chain-scoped dialog (ADR-0017).
