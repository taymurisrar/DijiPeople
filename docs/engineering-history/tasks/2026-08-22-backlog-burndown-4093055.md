...
| **Final Task SHA** | `409305537a42bc53160315eb2cd0b29b46d668a6` |
...
| | |
|---|---|
| **CI Run ID** | TODO — filled from the run whose `CI required gate` verdict authorised the merge |
| **CI Result** | TODO — filled after the verdict |
