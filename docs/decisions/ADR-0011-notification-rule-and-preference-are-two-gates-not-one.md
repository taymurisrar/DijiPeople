...
---
# ADR-0011 — `NotificationRule` and `NotificationPreference` both stay, as two gates on one dispatch path
...
- [`EXECPLAN-0042`](../plans/EXECPLAN-0042-notification-rule-administration-and-unified-dispatch-gate.md)
