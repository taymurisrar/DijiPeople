...
| [[ITEM-0069-a-global-identity-lock-can-be-triggered-by-an-unauthenticate|ITEM-0069]] | A global identity lock can be triggered by an unauthenticated attacker | SECURITY | MEDIUM | READY | auth, users | PLAN_REQUIRED |
