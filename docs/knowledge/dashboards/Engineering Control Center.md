...
|---|---|---|---|---|---|---|---|
| [[SESSION-0078-attendance-location-capture-is-blocked-by-permissions-policy|SESSION-0078]] | — | Attendance location capture is blocked by Permissions-Policy; validate every attendance scenario | ACTIVE | `agent/attendance-location-capture` | `develop` | — | NO |
