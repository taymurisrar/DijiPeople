...
|---|---|---|---|---|---|---|---|
| [[SESSION-0054-dlp-capture-go-live-readiness-rule-ui-seeds-body-limit-captu|SESSION-0054]] | — | DLP capture go-live readiness: rule UI, seeds, body limit, captures view | ACTIVE | `agent/dlp-go-live` | `develop` | — | NO |
...
| [[TASK-0023-dlp-capture-go-live-readiness|TASK-0023]] | DLP capture go-live readiness | FEATURE | LARGE | 4/4 | WP-04 | — | — |
