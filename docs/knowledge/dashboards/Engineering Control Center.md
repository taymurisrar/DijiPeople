...
|---|---|---|---|---|---|---|---|
| [[SESSION-0062-agent-distribution-storage-ci-auto-build-publish-download-ad|SESSION-0062]] | — | Agent distribution: storage, CI auto-build/publish, download, admin versioning | ACTIVE | `agent/agent-distribution` | `develop` | — | NO |
...
| [[TASK-0025-agent-app-distribution-and-auto-release-pipeline|TASK-0025]] | Agent app distribution and auto-release pipeline | FEATURE | LARGE | 6/6 | WP-06 | — | — |
