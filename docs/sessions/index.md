...
**Active: 7** · completed: 27

## Active

| Session | Task | Title | Status | Branch | Target | Leases | Heartbeat |
|---|---|---|---|---|---|---|---|
| [SESSION-0035](../../docs/sessions/SESSION-0035-document-rendering-fidelity-editor-stability-admin-theme-sti.md) | TASK-0015 | Document rendering fidelity, editor stability, admin theme, sticky fields rail, and a stuck tenant | ACTIVE | `agent/document-render-and-theme` | `develop` | — | 2026-08-21T20:58:56.938Z |
