...
**Active: 7** · completed: 34

## Active

| Session | Task | Title | Status | Branch | Target | Leases | Heartbeat |
|---|---|---|---|---|---|---|---|
| [SESSION-0042](../../docs/sessions/SESSION-0042-public-site-pricing-features-page-forms-checkout-agreements-.md) | — | Public site pricing, features page, forms, checkout agreements, and admin plan/tenant list fixes | ACTIVE | `agent/site-ux-and-admin-fixes` | `develop` | — | 2026-08-22T21:25:54.373Z |
