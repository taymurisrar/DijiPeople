...
### REG-413 — A tenant's Light default was never in reach of the frame that needed it
...
### REG-414 — Two authorization models for one settings section, and a redirect where a refusal belonged
...
### REG-415 — A measurement copy that was invisible and still tabbable, and a tab strip with no tab semantics
...
### REG-416 — A section and its self-titling widget both insisted on naming the same control
