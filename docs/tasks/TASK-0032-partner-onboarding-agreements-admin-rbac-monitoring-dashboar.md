...
BLOCKED_PACKAGES: []
OWNER_DECISIONS: 1
FINAL_STATUS: COMPLETE_WITH_WARNINGS — integrated into develop at dfe42ea9 behind a green exact-SHA gate (CI run 36159588565); 31 bugs fixed, 4 items done; not deployed (production out of scope by owner instruction); deferred with disposition: BUG-3220, BUG-3231, BUG-3588, ITEM-0200, ITEM-0201 (optimistic concurrency)
---
