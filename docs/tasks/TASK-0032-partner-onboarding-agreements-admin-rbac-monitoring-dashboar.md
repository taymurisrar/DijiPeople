...
|---|---|---|---|---|---|---|---|---|---|---|
| WP-00 | Discovery, records, ADR-0018..0020, ExecPlan | IN_PROGRESS | — | architect, qa | agent/partner-agreements-admin-hardening | — | — | see records-map | — | — |
| WP-01 | Schema: MFA, platform lockout, error module, signature style, role consolidation migration | NOT_STARTED | — | database | agent/pah-wp01-schema | — | — | — | — | — |
| WP-02 | Platform RBAC and Super Admin: permission-only platform authorization, tenant edit, heartbeat, role consolidation | NOT_STARTED | — | backend-api, security, frontend | agent/pah-wp02-rbac | — | — | — | — | — |
| WP-03 | TOTP MFA for web and admin, platform lockout, TTL parsing | NOT_STARTED | WP-01, WP-02 | backend-api, security, frontend | agent/pah-wp03-mfa | — | — | — | — | — |
| WP-04 | Partner domain: type behaviour policy, duplicates, audit, lead attribution UX | NOT_STARTED | — | backend-api, frontend | agent/pah-wp04-partners | — | — | — | — | — |
| WP-05 | Agreements: contextual placeholders, source guards, audit, signature rendering, agreement UX | NOT_STARTED | WP-01 | backend-api, frontend | agent/pah-wp05-agreements | — | — | — | — | — |
| WP-06 | Monitoring and observability: health overview, grouped errors, correlation, redaction | NOT_STARTED | WP-01 | backend-api, frontend | agent/pah-wp06-monitoring | — | — | — | — | — |
| WP-07 | Platform operations dashboard | NOT_STARTED | WP-01 | backend-api, frontend, ui-ux | agent/pah-wp07-dashboard | — | — | — | — | — |
| WP-08 | Admin CRUD and tenant management sweep: error UX, tenant edit UX, boundaries | NOT_STARTED | WP-02 | frontend, qa | agent/pah-wp08-admin-crud | — | — | — | — | — |
