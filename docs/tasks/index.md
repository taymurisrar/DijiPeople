...
| [TASK-0012](TASK-0012-final-agent-operating-system-upgrade.md) | WP-08 | Agent role enhancements across the permanent set |
...
- [TASK-0011](TASK-0011-first-production-release.md) — 1 owner decision(s) outstanding
...
| [TASK-0012](TASK-0012-final-agent-operating-system-upgrade.md) | Final agent operating system upgrade | FRAMEWORK | PROGRAM | P0 | IN_PROGRESS | 9/16 | WP-08 |
