...
| WP-06 | Seat change and plan change lifecycle | CI | WP-04, WP-05 | Backend/API, Integration | agent/commercial-platform-completion | ce9bb56 | PASS | PENDING_EXACT_SHA | NOT_STARTED |
| WP-07 | Payment to onboarding to provisioning automation, steps, resumability, targets | CI | WP-01, WP-05 | Backend/API, Database, Integration | agent/commercial-platform-completion | ce9bb56 | PASS | PENDING_EXACT_SHA | NOT_STARTED |
