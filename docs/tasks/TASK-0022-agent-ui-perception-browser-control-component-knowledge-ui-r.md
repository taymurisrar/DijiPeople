...
- 2026-08-25 — WP-01 and WP-02 implemented and committed at `0e224a69`.
- 2026-08-25 — WP-03 and WP-04 implemented; MCP server verified to start and
  expose 24 browser tools against the committed `.mcp.json`.
