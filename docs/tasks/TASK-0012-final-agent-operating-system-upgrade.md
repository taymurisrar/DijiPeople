...
| WP-02 | Question escalation protocol and decision memory | NOT_STARTED | WP-01 | Architect | agent/agent-operating-system | — | — | — | — | — |
| WP-03 | Product and Backlog Steward role and backlog ownership | NOT_STARTED | WP-01 | Product & Backlog Steward | agent/agent-operating-system | — | — | — | — | — |
| WP-04 | Knowledge and Graph role and the Obsidian node contract | NOT_STARTED | WP-01 | Knowledge & Graph | agent/agent-operating-system | — | — | — | — | — |
| WP-05 | Large-task persistence, work-package files and context budget | NOT_STARTED | WP-01 | Architect | agent/agent-operating-system | — | — | — | — | — |
| WP-06 | Evidence cache and invalidation | NOT_STARTED | WP-05 | Release/DevOps | agent/agent-operating-system | — | — | — | — | — |
| WP-07 | Test resource lifecycle and cleanup registry | NOT_STARTED | WP-01 | QA | agent/agent-operating-system | — | — | — | — | — |
...
| WP-09 | Failure adaptation, failure budget and research mode | NOT_STARTED | WP-01 | Architect | agent/agent-operating-system | — | — | — | — | — |
| WP-10 | Agent health, architecture debt and improvement budget | NOT_STARTED | WP-03 | Product & Backlog Steward | agent/agent-operating-system | — | — | — | — | — |
