...
> **Verified against commit:** 05354d9
> **Key source files:** scripts/retrieve-knowledge.mjs, scripts/sync-obsidian.mjs, .obsidian-sync.example.json, docs/knowledge/README.md, docs/qa/README.md, .agent/context/README.md
>
...
Six knowledge systems, each answering **one** question. Using the wrong one is
...
| **Obsidian vault** | *Why does it work this way, and what happened before?* | Requirements, product intent, meetings, client feedback, bug history, long-term project memory |
...
| `11 - Agent Knowledge` | QA runs, regressions, bug patterns |
